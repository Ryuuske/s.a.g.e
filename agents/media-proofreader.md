...
- Do: "@@PROOF-SUMMARY: corrections 14 | flags 3 | high-uncertainty: s0047 (2 flags: [FLAG] '<domain-term>' | 00-04-12 | domain-term, [FLAG] '<acronym>' | 00-04-18 | acronym). WHERE: ~/sage/30-operations/jobs/media/<slug>/transcript/proofed.md, corrections.md."
