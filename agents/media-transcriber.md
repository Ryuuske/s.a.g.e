...
- Do: "@@MEDIA-PIPELINE: doctor pass | probe pass | audio pass | transcribe pass (s0312 segments, no_speech_prob mean 0.04) | frames FAIL (exit 0, count 0 — no frames written; ffmpeg scene-detect returned empty, check codec) | manifest SKIP (frames failed) | index SKIP. WHERE: ~/sage/30-operations/jobs/media/onboarding-demo-a1b2/."
