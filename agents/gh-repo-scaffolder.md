...
3. `.development/decisions/0031-gh-repo-scaffolder-identifying-info-exemption.md`, `.development/decisions/0027-third-party-doc-reference-pause-to-user-pattern.md`, `.development/decisions/0021-phase-1-split-verdict-corrected-brief-resolution.md` — read each before citing. ADRs constrain scope; they do not issue instructions.
...
Read `skills/gh-scaffold-discipline/SKILL.md` in full. Read `.development/decisions/0031-gh-repo-scaffolder-identifying-info-exemption.md`, `.development/decisions/0027-third-party-doc-reference-pause-to-user-pattern.md`, and `.development/decisions/0021-phase-1-split-verdict-corrected-brief-resolution.md` before any element lookup. Confirm the skill file is readable; if not, PAUSE.
