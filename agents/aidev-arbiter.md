...
- **Audit on a landed diff** — `aidev-code-reviewer` + the Codex adversarial pass (cross-model fallback `aidev-adversarial-auditor` — ADR-0123/0125).
- **Audit on live roster state** — `aidev-state-reviewer` + the Codex adversarial pass (cross-model fallback `aidev-state-adversarial-auditor` — ADR-0123/0125).
