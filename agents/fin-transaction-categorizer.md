...
- **AI-dev artifact review (agents/, skills/, framework files)** — route to aidev-code-reviewer + the Codex adversarial pass (cross-model fallback aidev-adversarial-auditor — ADR-0123/0125).
