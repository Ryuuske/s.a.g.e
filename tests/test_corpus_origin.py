...
TDD: these tests fail until sage/corpus_origin.py is implemented."""

from sage_mcp.corpus_origin import (
    CorpusOriginResult,
...
class TestHeuristic:
    ...
    def test_brand_terms_case_insensitive(self):
        ...
        samples = [
            ...
            "added sage as an mcp server in my .claude/ settings file",
...
class _FakeProvider:
    """Minimal stand-in for sage's LLMProvider used for testing."""
