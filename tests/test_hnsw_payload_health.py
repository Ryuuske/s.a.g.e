...
def test_quarantine_catches_link_bloat_without_mtime_drift(tmp_path):
    ...
    seg_dir = nook / "11111111-2222-3333-4444-555555555555"
    _write_segment(
        seg_dir,
        data_size=100,
        link_size=int(100 * (_HNSW_LINK_TO_DATA_MAX_RATIO + 1)),
    ...
    moved = quarantine_stale_hnsw(str(nook), stale_seconds=999_999)
...
def test_quarantine_catches_zero_byte_link_lists_when_stale(tmp_path):
    ...
    moved = quarantine_stale_hnsw(str(nook), stale_seconds=300)
