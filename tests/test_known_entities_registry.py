...
def test_populated_registry_improves_miner_recall(temp_registry):
    ...
    miner.add_to_known_entities(
        {
            ...
            "projects": ["hyperion-history", "sage"],
        }
    )

    sample = (
        "Met with Julia Grib yesterday about the sage release. "
    ...
    for expected in ("Julia Grib", "Kevin Heifner", "hyperion-history", "sage"):
