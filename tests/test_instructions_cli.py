"""Tests for sage.instructions_cli — instruction text output."""

from unittest.mock import patch

import pytest

from sage_mcp.instructions_cli import AVAILABLE, INSTRUCTIONS_DIR, run_instructions
...
def test_run_instructions_missing_md_file(capsys, tmp_path):
    ...
    with patch("sage_mcp.instructions_cli.INSTRUCTIONS_DIR", tmp_path):
        with patch("sage_mcp.instructions_cli.AVAILABLE", ["fakecmd"]):
            with pytest.raises(SystemExit) as exc_info:
