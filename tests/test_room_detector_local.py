"""Tests for sage.room_detector_local."""

from unittest.mock import MagicMock, patch

from sage_mcp.room_detector_local import (
    FOLDER_ROOM_MAP,
...
def test_detect_rooms_local_yes_mode(tmp_path):
    ...
    assert (tmp_path / "sage.yaml").exists()
...
def test_detect_rooms_local_interactive(tmp_path):
    ...
    with (
        patch.dict("sys.modules", {"sage_mcp.miner": mock_miner}),
        patch(
            "sage_mcp.room_detector_local.get_user_approval",
