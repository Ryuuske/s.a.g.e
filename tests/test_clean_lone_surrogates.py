...
from sage_mcp.config import strip_lone_surrogates
...
class TestToolsAcceptSurrogates:
    ...
    def test_update_drawer(self, monkeypatch, collection, config, kg):
        _patch_mcp_server(monkeypatch, config, kg)
        from sage_mcp.mcp_server import tool_add_drawer, tool_update_drawer
