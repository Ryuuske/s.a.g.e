"""i18n — Language dictionaries for sage.
...
``sage.entity_detector``. See ``get_entity_patterns`` for the merge rules
...
def _canonical_lang(lang: str) -> Optional[str]:
    ...
    BCP 47 tags are case-insensitive (RFC 5646), and the locale
