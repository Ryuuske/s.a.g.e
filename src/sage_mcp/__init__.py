...
def _strip_leaked_pythonpath_from_sys_path() -> None:
    ...
    # (sage_mcp.cli:main, sage_mcp.mcp_server:main) drop PYTHONPATH from
    # the env themselves so any subprocess they spawn starts clean. Host
    # applications that embed sage as a library (e.g. import
    # sage_mcp.searcher) keep their PYTHONPATH intact for their own
