#!/usr/bin/env python3
"""
spellcheck.py — Spell-correct user messages before nook filing.
...
# CamelCase: ChromaDB, sage, LongMemEval
...
if __name__ == "__main__":
    test_cases = [
        ...
        "sage cant be fine-tunned if you alredy kno the question",
    ...
    for msg in test_cases:
        result = spellcheck_user_text(msg, known_names={"riley", "sam", "sage"})
