"""
exporter.py — Export the nook as a browsable folder of markdown files.
...
def export_nook(nook_path: str, output_dir: str, format: str = "markdown") -> dict:
    """Export all nook drawers as markdown files organized by wing/room.
    ...
    if total == 0:
        print("  Nook is empty — nothing to export.")
