...
from sage_mcp.llm_client import LLMError, LLMProvider
...
SYSTEM_PROMPT = """You are helping organize a user's memory nook by classifying capitalized tokens found in their files.
...
def _build_corpus_origin_preamble(corpus_origin: dict | None) -> str:
    ...
    can concatenate unconditionally without changing the the prior prompt
...
def collect_corpus_text(
    ...
    from sage_mcp.entity_detector import PROSE_EXTENSIONS, SKIP_DIRS
