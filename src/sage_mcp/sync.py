...
Usage:
    ...
    report = sync_nook(nook_path, project_dirs=["/repo"], dry_run=True)
"""
...
def sync_nook(
    ...
    with mine_nook_lock(nook_path):
        ...
        matcher_cache: dict = {}
        # Same source_file → same verdict holds because mine_nook_lock
